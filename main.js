...
document.getElementById("trazo").innerHTML = "dibujo a trazar: " + sketch;
...
function updateCanvas()
{
       ...
       console.log(quick_draw_data_set[random_no]);
       sketch = quick_draw_data_set [random_no];
       document.getElementById("trazo").innerHTML = "Dibujo a trazar: " + draw_sketch;
}
function setup() 
{
...
function gotResults(error, results)
{
    ...
    document.getElementById("confidence").innerHTML = "confianza: " + Math.round(results[0]. confidece * 100) + '%' 
}